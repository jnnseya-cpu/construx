...
Five packages, from a 30-day trial through **Solo £100** for a sole trader to **Enterprise £6,500**. Every paid package credits 20% of its price as AI each month — £100 buys 2,000 ACUs, £950 buys 19,000, £6,500 buys 130,000. On top of that, prepaid ACU bundles that credit what they cost: **Solo £50** (5,000 ACUs), **Starter £300** (30,000), **Growth £1,000** (100,000), **Scale £2,500** (250,000). Provider cost is charged at between 4× and 10× — the top of the range at the smallest monthly usage, stepping down to 4× as an account grows, and 4× is a floor nothing goes below. So a £300 bundle funds between £30 and £75 of provider work depending on how heavily the account uses AI, and the multiplier each charge was raised at is on its own ledger entry rather than inferred. Per-engine attribution, and **no provider call on an empty wallet** — prepaid means prepaid. Sell this as budget control, because that is what a commercial director hears: *"your AI spend cannot surprise you."* One nuance to be straight about in a deal: a company's own AI *cap* is a reporting ceiling rather than a kill switch — an AI task that passes one finishes and is charged, because a reasoning run stopped half way has spent the tokens and produced nothing usable. The balance is the hard stop.
...
| **AI cost exceeds the 4×–10× markup range** | Gross margin below 75% | The ACU model already caps exposure per tenant. Reprice bundles, do not absorb it. |
