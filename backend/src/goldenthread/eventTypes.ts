...
export const EVENT_TYPES: EventTypeDefinition[] = [
  ...
  // recordable, and an acceptance is the person, not the sender, acting.
  ...
  // How a paying account agreed to be collected from, going forward: the
  // method, the amount a month, the company and the exact sentence. A record
  ...
  def('SERVICE_PAYMENT_RECORDED', 'ValuationPayment', 'CREATE', 'COMMERCIAL', { creates: true }),
  ...
  def('SERVICE_DELIVERY_CHECKED', 'ServiceDelivery', 'UPDATE', 'DELIVERY', { aiAllowed: true }),
  def('ACCOMMODATION_ROOM_REGISTERED', 'AccommodationRoom', 'CREATE', 'DELIVERY', { aiAllowed: true, creates: true }),
  def('ACCOMMODATION_ROOM_STATUS_SET', 'AccommodationRoom', 'UPDATE', 'DELIVERY'),
  def('BED_ALLOCATED', 'BedAllocation', 'CREATE', 'DELIVERY', { aiAllowed: true, creates: true }),
  def('BED_CHECKED_IN', 'BedAllocation', 'UPDATE', 'DELIVERY', { aiAllowed: true }),
  def('BED_CHECKED_OUT', 'BedAllocation', 'UPDATE', 'DELIVERY', { aiAllowed: true }),
  def('TRANSPORT_JOURNEY_SCHEDULED', 'TransportJourney', 'CREATE', 'DELIVERY', { aiAllowed: true, creates: true }),
  def('TRANSPORT_SEAT_BOOKED', 'TransportJourney', 'UPDATE', 'DELIVERY', { aiAllowed: true }),
  def('TRANSPORT_JOURNEY_UPDATED', 'TransportJourney', 'UPDATE', 'DELIVERY', { aiAllowed: true }),
