...
export async function handover(root) {
  ...
  const [
    ...
    api.read(`/v1/projects/${projectId}/as-built`, 'DESIGN_INFORMATION').catch((error) => ({ error })),
    ...
    api.read(`/v1/projects/${projectId}/practical-completion`, 'QUALITY_COMMISSIONING').catch((error) => ({ error })),
    ...
    api.read(`/v1/projects/${projectId}/systemisation`, 'QUALITY_COMMISSIONING').catch((error) => ({ error })),
    api.read(`/v1/projects/${projectId}/systems/integrity`, 'QUALITY_COMMISSIONING').catch((error) => ({ error })),
    api.read(`/v1/projects/${projectId}/commissioning-close`, 'QUALITY_COMMISSIONING').catch((error) => ({ error })),
    api.read(`/v1/projects/${projectId}/reliability`, 'QUALITY_COMMISSIONING').catch((error) => ({ error })),
    api.read(`/v1/projects/${projectId}/functional-tests`, 'QUALITY_COMMISSIONING').catch((error) => ({ error })),
    api.read(`/v1/projects/${projectId}/pre-functional-checks`, 'QUALITY_COMMISSIONING').catch((error) => ({ error })),
    api.read(`/v1/projects/${projectId}/commissioning-exceptions`, 'QUALITY_COMMISSIONING').catch((error) => ({ error })),
    api.read(`/v1/projects/${projectId}/vendor-tests`, 'QUALITY_COMMISSIONING').catch((error) => ({ error })),
